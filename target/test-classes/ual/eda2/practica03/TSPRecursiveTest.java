...
public class TSPRecursiveTest {

    @Test
    public void testTspRecursive_NullGraph() {
        // Ejecutar TSP recursivo con grafo nulo
        Solucion result = TSPRecursive.recursiveTSP(null, new Vertex("A"));
    ...
    public void testTspRecursive_EmptyGraph() {
        ...
        Solucion result = TSPRecursive.recursiveTSP(grafo, A);
    ...
    public void testTspRecursive_InvalidStartVertex() {
        ...
        // Ejecutar TSP recursivo
        Solucion result = TSPRecursive.recursiveTSP(grafo, B);
    ...
    public void testTspRecursive_DifferentStartingPoints() {
        ...
        Solucion resultA = TSPRecursive.recursiveTSP(grafo, A);
        Solucion resultB = TSPRecursive.recursiveTSP(grafo, B);
        Solucion resultC = TSPRecursive.recursiveTSP(grafo, C);
