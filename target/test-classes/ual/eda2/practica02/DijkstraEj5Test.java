...
/**
 * Clase de prueba para la implementación del algoritmo Dijkstra con heurística (DijkstraEj5).
 * Este conjunto de pruebas verifica la funcionalidad del algoritmo en diferentes escenarios,
 * como grafos simples, desconectados, con ciclos y casos donde no hay caminos posibles.
 */
public class DijkstraEj5Test {

    /**
     * Prueba el algoritmo de Dijkstra en un grafo simple y conectado.
     * Verifica que las distancias calculadas y el camino encontrado sean correctos.
     */
    @Test
    void testSimpleGraph() {
        ...
        Map<String, Object> result = DijkstraEj5.findPath(graph, source, destination, positions);
     ...
     * Verifica que las estadísticas como tiempo de ejecución, nodos evaluados y generados sean válidas.
     */
    @Test
    void testPerformanceMetrics() {
        ...
        Assertions.assertTrue(nodosEvaluados > 0, "Debe haber nodos evaluados");
        Assertions.assertTrue(nodosGenerados > 0, "Debe haber nodos generados");
    }
