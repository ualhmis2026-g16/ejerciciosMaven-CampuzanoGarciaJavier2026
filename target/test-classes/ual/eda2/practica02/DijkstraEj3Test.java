...
/**
 * Clase de prueba para la implementación del algoritmo de Dijkstra (DijkstraEj3).
 * Contiene diferentes pruebas unitarias diseñadas para verificar el comportamiento 
 * del algoritmo en diversos escenarios, como grafos simples, desconectados y con ciclos.
 */
class DijkstraEj3Test {

    /**
     * Prueba el algoritmo de Dijkstra en un grafo simple y conectado.
     * Verifica que las distancias calculadas sean correctas y que las estadísticas
    ...
    void testSimpleGraph() {
        ...
        Vertex source = a;
        Map<String, Object> result = DijkstraEj3.Dijkstra(graph, source);
    ...
    /**
     * Prueba el algoritmo de Dijkstra en un grafo donde no hay caminos entre los vértices.
     * Verifica que los vértices no alcanzables tengan una distancia infinita.
     */
    @Test
    void testNoPath() {
        ...
        // Verificar distancias
        assertEquals(null, dist.get(a), "Distancia al vértice fuente debe ser infinita");
        assertEquals(null, dist.get(b), "Vértice no alcanzable debe tener distancia infinita");
    }
}