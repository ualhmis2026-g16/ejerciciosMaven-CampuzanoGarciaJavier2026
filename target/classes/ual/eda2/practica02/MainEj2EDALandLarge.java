...
public class MainEj2EDALandLarge {
	/**
	 * metodo main que se encarga de realizar la ejecucion de DijkstraEj2
    ...
    public static void main(String[] args) {
        ...
        Map<String, Object> results = DijkstraEj2.Dijkstra(graph, source);
