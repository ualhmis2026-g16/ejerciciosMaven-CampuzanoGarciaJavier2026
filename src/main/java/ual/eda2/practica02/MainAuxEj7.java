...
public class MainAuxEj7 {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("\nEjecutando algoritmo DijkstraBestFirstWPP desde " + sourceId + ":");
            TreeMap<String, Object> result = DijkstraEj7.Dijkstra(cityGraph, source);
            ...
            System.out.println("\nCamino más ancho desde " + sourceId + " hasta " + destId + ":");
            System.out.println("Ancho de banda: " + distance);
